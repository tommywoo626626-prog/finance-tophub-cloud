...
CATEGORY_RULES = [
    ...
    },
    {
        "keywords": {
            ...
            "道指": 3, "美股": 3, "科技股": 3, "AI开支": 3, "AI算力": 3, "AI概念": 2, "WAIC": 3,
    ...
    {
        "keywords": {
            "关税": 3, "加征": 3, "贸易战": 3, "出口管制": 3, "贸易摩擦": 2,
            "芯片禁令": 3, "制裁": 2, "实体清单": 3, "脱钩": 2,
        },
        "category": "关税贸易",
        "insight_tpl": "关税和贸易政策变动直接影响全球供应链布局。出口企业面临成本上升和市场准入双重压力，产业链转移加速。",
        "angles": [
            "出口企业视角：关税加征对相关行业利润率的直接冲击有多大",
            "供应链视角：产业链转移加速，哪些国家和企业受益",
            "反常识观点：关税不一定是纯利空，倒逼国产替代和产业升级",
            "博弈视角：贸易谈判的筹码逻辑，双方底线在哪里",
            "投资视角：关税敏感型板块的短期情绪和长期价值博弈",
        ],
    },
    {
        "keywords": {
            "电网": 3, "特高压": 3, "电力设备": 3, "配电": 2, "变压器": 3,
            "智能电网": 3, "虚拟电厂": 3, "充电桩": 2, "涨停": 2,
        },
        "category": "电力设备",
        "insight_tpl": "电力设备板块批量涨停，背后是电网投资加速和新能源消纳需求的双重驱动。特高压和智能电网建设进入兑现期。",
        "angles": [
            "政策视角：电网投资计划的资金规模和落地节奏",
            "产业链视角：从变压器到特高压，哪些环节最受益",
            "订单视角：头部企业的在手订单和产能利用率",
            "反常识观点：电力设备不是纯周期股，结构性增长逻辑正在兑现",
            "估值视角：板块估值是否已经反映预期，还有多少空间",
        ],
    },
    {
        "keywords": {
            "茅台": 5, "五粮液": 5, "白酒": 3, "泸州老窖": 4, "汾酒": 4,
            "高端消费": 2, "供需": 2, "批价": 3, "飞天": 3,
        },
        "category": "白酒消费",
        "insight_tpl": "白酒价格和供需关系是消费板块的风向标。茅台批价波动牵动整个高端白酒估值锚，市场在问：是短期库存周期还是长期需求变化？",
        "angles": [
            "价格视角：茅台批价走势是消费景气度的先行指标",
            "供需视角：产量控制和渠道库存的博弈关系",
            "消费视角：高端消费降级还是分化？不同价格带的表现差异",
            "反常识观点：茅台降价不一定是利空，可能挤压竞品扩大份额",
            "投资视角：白酒板块估值处于历史什么分位，何时配置",
        ],
    },
    {
        "keywords": {
            "银行": 3, "AIC": 3, "信贷": 2, "息差": 3, "不良率": 3,
            "金融": 1, "城商行": 3, "股份行": 3, "国有大行": 3,
            "资本充足率": 3, "拨备": 2,
        },
        "category": "银行金融",
        "insight_tpl": "银行板块的息差、资产质量和信贷投放是核心看点。在支持实体经济和维持自身盈利之间，银行正在走平衡木。",
        "angles": [
            "息差视角：LPR下调对银行净息差的传导效应有多大",
            "资产质量：不良率、拨备覆盖率和关注类贷款的变化趋势",
            "业务视角：AIC和子公司布局对银行估值的重估逻辑",
            "反常识观点：银行股低估值不一定是机会，要看ROE能否企稳",
            "分红视角：高股息策略下，银行股的配置价值如何",
        ],
    },
